...
class SmartFileAnalyzerUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        # Sheet Name
        settings_layout.addWidget(QLabel("Excel Sheet Name:"))
        self.sheet_name_input = QLineEdit()
        self.sheet_name_input.setPlaceholderText("Analysis Results")
        self.sheet_name_input.setFixedWidth(200)
        settings_layout.addWidget(self.sheet_name_input)
    ...
    def export_results(self):
        if self.analysis_results:
            ...
            path = self.file_utils.export_results_to_excel(self.analysis_results, sheet_name=sheet_name)
